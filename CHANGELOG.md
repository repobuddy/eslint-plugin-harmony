...
- f22cbed: `@typescript-eslint/parser` is no longer a dependency of this package. It is now an
  ...
  **If you use any eslintrc `ts-*` config you must now install it yourself** —
  ...
  Why: as a runtime dependency, a package manager installs a copy _inside_
